export const ja = {
  ...
  'shortcut.penPrevious': '前のペンに切り替え',
  'shortcut.penNext': '次のペンに切り替え',
  'shortcut.layerUp': '上のレイヤーに切り替え',
  'shortcut.layerDown': '下のレイヤーに切り替え',
  'shortcut.toolPen': 'ペンツールに切り替え',
  'shortcut.toolEraser': '消しゴムツールに切り替え',
  'shortcut.toolFill': '塗りつぶしツールに切り替え',
  'shortcut.toolSelect': '選択ツールに切り替え',
  'shortcut.toolMove': '移動ツールに切り替え',
  'shortcut.toolPrevious': '前のツールに切り替え',
  'shortcut.toolNext': '次のツールに切り替え',
  'shortcut.toggleGrid': 'グリッド表示を切り替え',
  'shortcut.toggleTouchDrawing': 'タッチ描画無効を切り替え',
  'shortcut.add': '割り当てを追加',
  'shortcut.change': '変更',
  'shortcut.remove': '削除',
  'shortcut.reset': 'リセット',
  'shortcut.resetAll': 'すべてリセット',
  'shortcut.unassigned': '未割り当て',
  'shortcut.recording': 'キーまたはゲームパッドを入力 (Escapeでキャンセル)',
